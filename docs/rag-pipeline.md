...
3. MRA-004 extracts, chunks, and embeds documents in the worker.
4. MRA-005 exposes processing state and document management.
5. MRA-006 persists conversations and messages.
